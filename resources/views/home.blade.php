...
<div class="container" style="margin-top: 50px;">
    ...
    <h4 class="text-center">Administracion de las coordenadas</h4><br>

    <h5>Registrar coordenadas nuevas</h5>
    <div class="card card-default">
        <div class="card-body">
            <form id="addCustomer" class="form-inline" method="POST" action="">
                <div class="form-group mb-2">
                    <label for="name" class="sr-only">Coordenada</label>
                    <input id="name" type="text" class="form-control" name="name" placeholder="Remitente"
                           required autofocus>
                </div>
                <div class="form-group mx-sm-3 mb-2">
                    <label for="email" class="sr-only">Latitud</label>
                    <input id="email" type="text" class="form-control" name="email" placeholder="Latitud"
                           required autofocus>
                </div>
                <div class="form-group mb-2">
                    <label for="lon" class="sr-only">Longitud</label>
        ...
        <div class="modal-dialog modal-dialog-centered" style="width:55%;">
            <div class="modal-content" style="overflow: hidden;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success updateCustomer">Actualizar
                    </button>
                </div>
            </div>
        </div>
